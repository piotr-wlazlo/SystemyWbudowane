...
#include "../inc/lpc17xx_pinsel.h"		/* konfiguracja pinów */
#include "../inc/lpc17xx_gpio.h"		/* obsługa GPIO */
#include "../inc/lpc17xx_ssp.h"		/* obsługa interfejsu SPI (dla karty SD)*/
#include "../inc/lpc17xx_uart.h"		/* obsługa UART (komunikacja szeregowa) */
#include "../inc/lpc17xx_timer.h"		/* obsługa timera */
//#include "../inc/stdio.h"		/* standardowa biblio wejścia wyjścia */
#include "../inc/lpc17xx_adc.h"


#include "../inc/diskio.h"			/* obsługa systemu plików FAT i nośnika SD */
#include "../inc/ff.h"

#include "../inc/oled.h"			/* obsluga OLEDu */
#include "../inc/acc.h"
